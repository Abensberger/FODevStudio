...
Version: 4.30.915
Release Name: Regular
Build Date: 2019-12-11 15:59:04
...
2. Installation
 ...
 B. Run the setup from the jar file, using a Java VM of your choice.
    ...
    prompt:
      ...
      java -jar setup-4.30.915.jar
			
    If you are logged as user without administrative privileges on 
    Windows, you can run setup.bat
...
RenderX (r), Copyright (c) 1999-2019 RenderX, Inc.  All rights reserved.
Patents issued.
...
This product includes software developed by the ZXing project. 
ZXing ("Zebra Crossing") (https://github.com/zxing/zxing).
Destributed under Apache License 2.0
URL: https://github.com/zxing/zxing/blob/master/LICENSE
